...
## Regra Estrutural
Cada pasta contém um arquivo `mapa.md` que descreve seu propósito e lista seus conteúdos. Nenhuma IA deve operar em uma pasta sem antes ler o seu `mapa.md`.

## Estrutura de Diretórios

| Pasta | Propósito |
|---|---|
| `00_Inbox/` | Entradas brutas, rascunhos e outputs temporários de IAs externas aguardando triagem |
| `01_Contexto_Geral/` | Master prompt e identidade da empresa — leitura obrigatória antes de qualquer operação |
